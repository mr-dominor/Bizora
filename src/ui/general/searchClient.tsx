...
import { priceLowToHigh,priceHighTolow,priceNewestFirst } from "@/ui/utilities/select"
...
export default function SearchClient({ data }: { data: Item[]}) {
  ...
  return (
    <div className="relative">
      <div
        ref={navbarRef}
        className="fixed top-0 left-0 right-0 h-24 bg-maroon text-white flex items-center px-4 z-30 shadow-lg"
      >
      </div>
